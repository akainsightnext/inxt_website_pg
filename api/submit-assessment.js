    ...
    'Foundation Level': {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <a href="${process.env.MAIN_WEBSITE_URL || 'https://insightnext.tech'}/contact.html" style="display: inline-block; background: #2563eb; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; margin: 20px 0;">Schedule Strategy Session</a>
    ...
    'Developing Level': {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <a href="${process.env.MAIN_WEBSITE_URL || 'https://insightnext.tech'}/contact.html" style="display: inline-block; background: #2563eb; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; margin: 20px 0;">Book Implementation Consultation</a>
    ...
    'Advanced Level': {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <a href="${process.env.MAIN_WEBSITE_URL || 'https://insightnext.tech'}/contact.html" style="display: inline-block; background: #16a34a; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; margin: 20px 0;">Discuss Advanced Strategies</a>
    ...
    'AI-Ready Level': {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <a href="${process.env.MAIN_WEBSITE_URL || 'https://insightnext.tech'}/contact.html" style="display: inline-block; background: #eab308; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; margin: 20px 0;">Explore Partnership Opportunities</a>
